...
final class VideoPreviewViewController: UIViewController {
    ...
    private let mediaCoordinator: MediaPlaybackCoordinator
    ...
    init(videoURL: URL, mediaCoordinator: MediaPlaybackCoordinator) {
    ...
    override func viewDidLoad() {
        ...
        setupUI()
        mediaCoordinator.setActiveVideoSession(pause: { [weak self] in
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        mediaCoordinator.setActiveVideoSession(pause: nil)
    ...
    private func setupPlayer() {
        Task {
            playerManager.configureCallbacks(
            ...
            mediaCoordinator.willBeginVideoPlayback()
            playerManager.play()
        }
    }
